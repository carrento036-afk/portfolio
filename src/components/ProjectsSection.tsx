    ...
    <section id="projects" className="section-padding relative z-10">
      <div className="container-narrow" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-8 sm:mb-10 max-w-xl text-base sm:text-lg px-2 sm:px-0">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-medium transition-all duration-300 active:scale-95 border ${
                  filter === cat
