...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 -right-1/4 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] lg:w-[800px] lg:h-[800px] rounded-full animate-[pulse_8s_ease-in-out_infinite] motion-reduce:animate-none opacity-50 pointer-events-none bg-[radial-gradient(circle,hsl(var(--gradient-start)/0.25)_0%,hsl(var(--gradient-mid)/0.1)_40%,transparent_70%)]" />
      <div className="absolute bottom-0 -left-1/4 w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] lg:w-[600px] lg:h-[600px] rounded-full animate-[pulse_10s_ease-in-out_infinite_reverse] motion-reduce:animate-none opacity-40 pointer-events-none bg-[radial-gradient(circle,hsl(var(--gradient-mid)/0.2)_0%,hsl(var(--gradient-end)/0.1)_40%,transparent_70%)]" />
      <div className="absolute top-1/2 left-1/3 w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] lg:w-[400px] lg:h-[400px] rounded-full animate-[pulse_12s_ease-in-out_infinite] motion-reduce:animate-none opacity-30 pointer-events-none bg-[radial-gradient(circle,hsl(var(--gradient-end)/0.15)_0%,transparent_60%)]" />
