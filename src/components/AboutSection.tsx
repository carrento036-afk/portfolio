...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            {/* About Text */}
            <div className="text-gray-300 leading-relaxed space-y-3 sm:space-y-4 text-base sm:text-lg text-left sm:text-justify max-w-3xl">
              <p>
            ...
            {/* Stats */}
            <div className="grid grid-cols-1 min-[400px]:grid-cols-3 gap-3 sm:gap-4 pt-4">
            {stats.map((stat, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
