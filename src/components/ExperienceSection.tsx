...
function ExperienceItem({
  ...
  return (
    <li ref={ref} className="relative mb-8 sm:mb-12 md:mb-16 flex w-full flex-col gap-1 pl-[50px] sm:pl-[90px]">
      ...
      <SpotlightCard delay={index * 0.05} className="h-full">
        <div className="p-6 md:p-8">
          <div className="mb-5 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex w-full flex-col items-start sm:items-end gap-2 md:w-auto md:flex-none">
